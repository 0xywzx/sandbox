...
import _0XywzxCosmos0XywzxCosmosCosmos from './0xywzx/cosmos/_0xywzx.cosmos.cosmos'
...
export default { 
  _0XywzxCosmos0XywzxCosmosCosmos: load(_0XywzxCosmos0XywzxCosmosCosmos, '_0xywzx.cosmos.cosmos'),
